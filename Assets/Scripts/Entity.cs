...
public abstract class Entity : MonoBehaviour
{
    ...
    //    //if (myType == EntityTypeEnum.Turret && (EntityType == EntityTypeEnum.Flying || EntityType == EntityTypeEnum.FlyingAW || EntityType == EntityTypeEnum.Walking || EntityType == EntityTypeEnum.WalkingAR))
    //    //{
    //    //    validTarget = true;
    //    //}
